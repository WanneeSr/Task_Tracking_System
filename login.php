...
if (isset($_SESSION['role'])) {
    switch ($_SESSION['role']) {
        case 'admin':
            ...
            break;
        case 'manager':
            header('Location: /task_tracking_system/manager/dashboard.php');
            break;
        case 'employee':
            header('Location: /task_tracking_system/index.php');
            break;
        ...
        <div class="w-full max-w-md">
            ...
            <div class="glass-effect rounded-3xl shadow-2xl p-8 space-y-8 border border-white/20">
                ...
                <form method="POST" class="space-y-6">
                    ...
                    <!-- Register Button -->
                    <a href="register.php" 
                       class="w-full flex items-center justify-center px-4 py-3 text-indigo-600 
                              bg-white border-2 border-indigo-600 rounded-xl
